      ...
      {user ? (
        <div>
          <div className="text-2xl mb-10 px-4 py-3 gap-20 w-screen bg-[#F3F4F6] flex">
            <button
              type="button"
              className="w-full flex items-center justify-center  px-5 py-2 text-sm  transition-colors duration-200  border-gray-700 rounded-lg gap-x-2 sm:w-auto hover:bg-gray-800 bg-gray-900 text-gray-200 "
            >
              <svg
